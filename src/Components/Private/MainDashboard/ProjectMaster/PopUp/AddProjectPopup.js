...
const AddProjectPopup = ({ handleAdd }) => {
    ...
    const handleProjectAdd = async (event) => {
        ...
        if (!finalCategory) {
            return toast.error("Please select or enter a project category");
        }
        if (isCustomCategory && finalCategory.length < 2) {
            return toast.error("Custom category must be at least 2 characters");
        }
        ...
        const totalPayment =
            Number(advancePay) +
            Number(payAgainstDelivery) +
            Number(payAfterCompletion);
        if (totalPayment > 100) {
            return toast.error(
                "The total payment percentage cannot exceed 100%"
            );
        }

        if (totalPayment < 90) {
            return toast.error(
                "Retention cannot be more than 10%. Please adjust payment terms."
            );
        }
        ...
        if (!POCopy) {
            return toast.error(
                "Please upload Purchase Order copy (PDF)"
            );
        }
                        ...
                        <div className="modal-body">
                            <div className="row modal_body_height">
                                ...
                                <div className="col-12 col-lg-6 mt-2">
                                    <div className="mb-3">
                                        <label
                                            htmlFor="purchaseOrderValue"
                                            className="form-label label_text"
                                        >
                                            Purchase Order Value (Rs){" "}
                                            <RequiredStar /> [Without GST]
                                        </label>
                                        <input
                                            type="number"
                                            step="0.01"
                                ...
                                <div className="col-12 col-lg-6 mt-2">
                                    <div className="mb-3">
                                        <label
                                            htmlFor="CategoryofProject"
                                            className="form-label label_text"
                                        >
                                            Category of Project <RequiredStar />
                                        </label>
                                        {!isCustomCategory ? (
                                            <select
                                ...
                                <div className="col-12 col-lg-6 mt-2">
                                    <div className="mb-3">
                                        <label
                                            ...
                                            className="form-label label_text"
                                        >
                                            Project Start Date <RequiredStar />
                                        </label>
                                        <input
                                            onChange={(e) =>
                                ...
                                <div className="col-12 col-lg-6 mt-2">
                                    <div className="mb-3">
                                        <label
                                            htmlFor="PurchaseOrderCopy"
                                            className="form-label label_text"
                                        >
                                            Purchase Order Copy{" "}
                                            <RequiredStar /> [PDF only, max
                                            2MB]
                                        </label>
                                        <input
                                            type="file"
