                      ...
                      <table className="table table-striped table-class" id="table-id">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="createEmployee"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" name="viewEmployee" id="permissions"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="updateEmployee"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="deleteEmployee"
                          ...
                          <tr>
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="createCustomer"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="viewCustomer"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="updateCustomer"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="deleteCustomer"
                          ...
                          <tr>
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="createProject"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="viewProject"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="updateProject"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="deleteProject"
                          ...
                          <tr>
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="createTask"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="viewTask"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="updateTask"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="deleteTask"
                          ...
                          <tr>
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="createTaskSheet"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="viewTaskSheet"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="updateTaskSheet"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="deleteTaskSheet"
                          ...
                          <tr>
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="createDepartment"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="viewDepartment"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="updateDepartment"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="deleteDepartment"
                          ...
                          <tr>
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="createDesignation"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="viewDesignation"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="updateDesignation"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" name="deleteDesignation" id="permissions"
                          ...
                          <tr>
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="createService"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="viewService"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="updateService"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="deleteService"
                          ...
                          <tr>
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="createLead"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="viewLead"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="updateLead"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" name="deleteLead" id="permissions"
                          ...
                          <tr>
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="createAnnualReport"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="viewAnnualReport"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="updateAnnualReport"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" name="deleteAnnualReport" id="permissions"
                          ...
                          <tr>
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="createActivityLog"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="viewActivityLog"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="updateActivityLog"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" name="deleteActivityLog" id="permissions"
                          ...
                          <tr>
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="createFeedback"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="viewFeedback"
                            ...
                            <td>
                              <label className="toggler-wrapper style-23">
                                <input type="checkbox" id="permissions" name="updateFeedback"
                            ...
                            <td>
                              <label className="toggler-wrapper style-23">
                                <input type="checkbox" name="deleteFeedback" id="permissions"
                          ...
                          <tr>
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="assignLead"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="viewMarketingDashboard"
                            ...
                            <td>
                              <label className="toggler-wrapper style-23">
                                <input type="checkbox" id="permissions" name="updateMarketing"
                            ...
                            <td>
                              <label className="toggler-wrapper style-23">
                                <input type="checkbox" name="deleteMarketing" id="permissions"
                          ...
                          <tr>
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="createAMC"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="viewAMC"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="updateAMC"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="deleteAMC"
                          ...
                          <tr>
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="createInventory"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="viewInventory"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="updateInventory"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="deleteInventory"
                          ...
                          <tr>
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="createVendor"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="viewVendor"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="updateVendor"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="deleteVendor"
                          ...
                          <tr>
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="createProduct"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="viewProduct"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="updateProduct"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="deleteProduct"
                          ...
                          <tr>
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="createPurchaseOrder"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="viewPurchaseOrder"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="updatePurchaseOrder"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="deletePurchaseOrder"
                          ...
                          <tr>
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="createGRN"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="viewGRN"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="updateGRN"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="deleteGRN"
                          ...
                          <tr>
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="createQC"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="viewQC"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="updateQC"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="deleteQC"
                          ...
                          <tr>
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="createDC"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="viewDC"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="updateDC"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="deleteDC"
                          ...
                          <tr>
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="createMRF"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="viewMRF"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="updateMRF"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="deleteMRF"
                          ...
                          <tr>
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="createSalesManagerMaster"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="viewSalesManagerMaster"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="updateSalesManagerMaster"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" name="deleteSalesManagerMaster" id="permissions"
                          ...
                          <tr>
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="createExhibition"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="viewExhibition"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="updateExhibition"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="deleteExhibition"
                          ...
                          <tr>
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="createExhibitionVisit"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="viewExhibitionVisit"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="updateExhibitionVisit"
                            ...
                            <td>
                              <label className="toggler-wrapper style-22">
                                <input type="checkbox" id="permissions" name="deleteExhibitionVisit"
